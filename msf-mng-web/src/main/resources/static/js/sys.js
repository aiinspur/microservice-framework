...
"use strict";
		...
		************************************************/
		...
		Chosen Form Control
		**************************************/
		$('.vo-control-chosen').chosen({
		  allow_single_deselect: true,
		  width: '100%'
		});
		$('.vo-control-chosen-required').chosen({
		  allow_single_deselect: false,
		  width: '100%'
		});
		$('.vo-control-chosen-search-threshold-100').chosen({
		  allow_single_deselect: true,
		  disable_search_threshold: 100,
		  width: '100%'
		});
		$('.vo-control-chosen-optgroup').chosen({
		  width: '100%'
		});
		$(function() {
		...
		*****************************************/
		...
		$('body').delegate('.theme-changer', 'click',  function(){
		 ...
		 $.fn.setThemeTone = function(primaryColor){
		 	...
		 	//alert(primaryColor+":"+localStorage.getItem("primaryColor"));
