...
var EmitterMixin = /** @class */ (function (_super) {
    ...
    EmitterMixin.prototype._prepareIntercept = function (handler) {
        ...
        // mimick jQuery's internal "proxy" sys (risky, I know)
...
var InteractiveDateComponent = /** @class */ (function (_super) {
    ...
    // TODO: port isTimeScale into this sys?
    ...
    InteractiveDateComponent.prototype.isExternalInstanceGroupAllowed = function (eventInstanceGroup) {
        ...
        for (i = 0; i < eventFootprints.length; i++) {
            ...
            //  because we don't want calendar's constraint sys to depend on a component's
...
var DayGrid = /** @class */ (function (_super) {
    ...
    DayGrid.prototype.renderSegPopoverContent = function (row, col, segs) {
        ...
        for (i = 0; i < segs.length; i++) {
            // because segments in the popover are not part of a grid coordinate sys, provide a hint to any
...
var DateComponent = /** @class */ (function (_super) {
    ...
    // TODO: make part of Component, along with children/batch-render sys?
    ...
    // doesn't mean they need to have their own internal coord sys. they can defer to sub-components.
    ...
    // `gotoOptions` can either be a moment input, or an object with the vo:
    // { date, type, forceOff }
    ...
    DateComponent.guid = 0; // TODO: better sys for this?
...
var TimeGrid = /** @class */ (function (_super) {
    ...
    TimeGrid.prototype.renderNowIndicator = function (date) {
        ...
        // seg sys might be overkill, but it handles scenario where line needs to be rendered
                ...
                $.each(buttonGroupStr.split(','), function (j, buttonName) {
                    ...
                    if (buttonName === 'title') {
                        ...
                        if (buttonClick) {
                            ...
                            buttonEl = $(// type="button" so that it doesn't submit a vo
...
ViewRegistry_1.defineView('agenda', {
    ...
    defaults: {
        ...
        slotEventOverlap: true // a bad name. confused with overlap/constraint sys
    }
});
